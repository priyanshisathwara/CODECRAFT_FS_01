...
export const registerUser = async (req, res) => {
  try {
    ...
    const checkSql = "SELECT * FROM authentication WHERE email = ?";
    db.query(checkSql, [email], async (err, results) => {
      ...
      // Insert new user
      const insertSql = "INSERT INTO authentication (name, email, password, role) VALUES (?, ?, ?, ?)";
...
export const sendResetPasswordMail = async (req, res) => {
  ...
  const sql = "UPDATE authentication SET otp = ? , otp_expire = ? WHERE email = ?";
...
export const verifyOtp = async (req, res) => {
 ...
 const sql = "SELECT * FROM authentication WHERE email = ? and otp = ? and otp_expire > ? ";
...
export const resetPassword = async (req, res) => {
  ...
  db.query(sql, [email], async (err, results) => {
    ...
    const updateSql = "UPDATE authentication SET password = ? WHERE email = ?";
...
export const resendResetPasswordMail = async (req, res) => {
  ...
  const sqlSelect = "SELECT otp_expire FROM authentication WHERE email = ?";
  ...
  db.query(sqlSelect, [email], (err, results) => {
    ...
    const sqlUpdate = "UPDATE authentication SET otp = ?, otp_expire = ? WHERE email = ?";
